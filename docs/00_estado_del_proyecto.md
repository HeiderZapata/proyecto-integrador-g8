...
| Documento final del PI (informe) | Equipo | **Esqueleto armado (NO consolidado aún)** | `docs/09_informe_final.md` (en `main`), estructura alineada a la rúbrica. Esqueleto con §3.2 EDA, §4 Tecnología y §3.5 A/B redactados; **faltan secciones y la consolidación**. Pendiente: (1) Yeison termina de **armar el esqueleto** con los insumos de Sara (§3.3–§3.4 modelo) y Kelly (§5 viz) + §1 intro y §2 marco; (2) Heider lo **lleva a Word**; (3) **completar de inicio a fin robusteciendo redacción, estilo y narrativa** |
