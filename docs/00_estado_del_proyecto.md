...
| Documento consolidado del PI | Equipo (Yeison) | **En curso** | `docs/09_informe_final.md` (en `main`), estructura alineada a la rúbrica oficial. **Redactados: §3.2 EDA, §4 Tecnología, §3.5 A/B.** Pendiente: §3.3–§3.4 (números finales de Sara), §5 viz, §1 intro, §2 marco teórico |
