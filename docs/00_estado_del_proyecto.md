...
| Documento consolidado del PI | Equipo (Yeison) | **En curso** | **Esqueleto creado** en `feat/doc` (`docs/09_informe_final.md`), estructura alineada a la rúbrica oficial; **§3.2 EDA y §4 Tecnología redactados**. Pendiente: §3.3–§3.4 (números finales de Sara), §3.5 A/B, §5 viz, §1/§2 |
