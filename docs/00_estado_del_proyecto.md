...
- **Yeison — A/B + documento + orquestación.** (1) Cerrar el **diseño del A/B test** sobre el segmento de mayor intención (C0 electrónica alto valor del clustering). (2) Liderar el **documento consolidado del PI**, integrando los resultados de los cuatro frentes. (3) Coordinar con Sara el cierre del **Contrato 2** (corte exacto del split / posible híbrido C+A).
