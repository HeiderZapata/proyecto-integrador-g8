...
- **Equipo — defensa.** **PPTX** con la narrativa del recorrido + **ensayo de defensa** filtrando en vivo + **Q&A por profesor** (insumo: `08_feedback_exposiciones_pregrado.md` §5).
